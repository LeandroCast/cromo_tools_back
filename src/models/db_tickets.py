...
class tickets(db.Model):
    __bind_key__ = 'gc'
    __tablename__= "leads_tickets"
    id = db.Column(UUID(as_uuid=True), primary_key=True, default=uuid.uuid4)
    id_lead = db.Column(UUID(as_uuid=True),default=uuid.uuid4)
    id_agency = db.Column(db.String(50), nullable=False)
    entrada_simulada = db.Column(db.String(50), nullable=False)
    parcelamento_simulado = db.Column(db.String(50), nullable=False)
    ...
    def __repr__(self):
        self.package  = {
            ...
            'entrada_simulada':self.entrada_simulada,
            'parcelamento_simulado':self.parcelamento_simulado,
